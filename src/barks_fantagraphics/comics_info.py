...
FANTAGRAPHICS_UPSCAYLED_RESTORED_DIRNAME = FANTAGRAPHICS_UPSCAYLED_DIRNAME + "-restored"
FANTAGRAPHICS_RESTORED_DIRNAME = FANTAGRAPHICS_DIRNAME + "-restored"
FANTAGRAPHICS_RESTORED_SVG_DIRNAME = FANTAGRAPHICS_DIRNAME + "-svg" + "-restored"
FANTAGRAPHICS_RESTORED_OCR_DIRNAME = FANTAGRAPHICS_RESTORED_DIRNAME + "-ocr"
FANTAGRAPHICS_FIXES_DIRNAME = FANTAGRAPHICS_DIRNAME + "-fixes-and-additions"
